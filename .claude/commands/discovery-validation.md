...
hooks:
  ...
  Stop:
    - hooks:
        # VALIDATION: Check validation report was created
        - type: command
          command: >-
        ...
        # VALIDATION: Check validation report has required sections
        - type: command
          command: >-
        ...
        - type: command
          command: "$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" command /discovery-validation ended '{"stage": "discovery", "validated": true}'
---
