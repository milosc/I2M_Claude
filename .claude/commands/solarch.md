...
hooks:
  ...
  Stop:
    - hooks:
        ...
        - type: command
          command: "$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" command /solarch ended '{"stage": "solarch", "validated": true}'
---
...
python3 "$CLAUDE_PROJECT_DIR/.claude/hooks/validate_traceability_backbone.py" --stage solarch || {
...
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  Phase 0: Initialization (Checkpoint 0)                        │
│  ├── Create folder structure                                   │
│  ├── Initialize _state/solarch_config.json                     │
│  └── Initialize _state/solarch_progress.json                   │
│                                                                 │
│  Phase 1: Input Validation (Checkpoint 1) [BLOCKING]           │
│  ├── Validate ProductSpecs completeness                        │
│  ├── Validate Prototype completeness                           │
│  └── Extract input summaries                                   │
│                                                                 │
│  Phase 2: Context & Goals (Checkpoint 2)                       │
│  ├── Generate 01-introduction-goals/                           │
│  ├── Generate 02-constraints/                                  │
│  └── Generate 03-context-scope/                                │
│                                                                 │
│  Phase 3: Solution Strategy (Checkpoint 3)                     │
│  ├── Generate 04-solution-strategy/                            │
│  └── Generate foundation ADRs (ADR-001, ADR-002)               │
│                                                                 │
│  Phase 4: Building Blocks (Checkpoint 4)                       │
│  ├── Generate 05-building-blocks/                              │
│  ├── Generate C4 diagrams                                      │
│  └── Register components in _registry/                         │
│                                                                 │
│  Phase 5: Runtime & Integration (Checkpoint 5)                 │
│  ├── Generate 06-runtime/ scenarios                            │
│  ├── Generate API design docs                                  │
│  └── Generate event communication docs                         │
│                                                                 │
│  Phase 6: Quality & Cross-cutting (Checkpoint 6)               │
│  ├── Generate 07-quality/                                      │
│  ├── Generate security architecture                            │
│  └── Generate cross-cutting concerns                           │
│                                                                 │
│  Phase 7: Deployment (Checkpoint 7)                            │
│  ├── Generate 08-deployment/                                   │
│  └── Generate operations guide                                 │
│                                                                 │
│  Phase 8: Decisions (Checkpoint 8)                             │
│  ├── Complete all ADRs (09-decisions/)                         │
│  └── Generate decision index                                   │
│                                                                 │
│  Phase 9: Risks (Checkpoint 9)                                 │
│  └── Generate 10-risks/                                        │
│                                                                 │
│  Phase 10: Documentation (Checkpoint 10)                       │
│  └── Generate 11-glossary/                                     │
│                                                                 │
│  Phase 11: Traceability (Checkpoint 11) [BLOCKING]             │
│  ├── Validate all chains                                       │
│  ├── 100% pain point coverage                                  │
│  └── 100% module architecture coverage                         │
│                                                                 │
│  Phase 12: Finalization (Checkpoint 12)                        │
