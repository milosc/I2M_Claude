...
hooks:
  ...
  Stop:
    - hooks:
        # VALIDATION: Check SolArch folder structure was created
        - type: command
          command: >-
        ...
        - type: command
          command: "$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" command /solarch-init ended '{"stage": "solarch", "validated": true}'
---
