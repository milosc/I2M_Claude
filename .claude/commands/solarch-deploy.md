...
hooks:
  ...
  Stop:
    - hooks:
        # VALIDATION: Check deployment view was created
        - type: command
          command: >-
        ...
        - type: command
          command: "$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" command /solarch-deploy ended '{"stage": "solarch", "validated": true}'
---
