---
name: rules-process-integrity
description: Load process integrity rules (TDD, quality gates, checkpoint validation)
---

# Process Integrity Rules (On-Demand)

**Loaded when needed**: Implementation Stage 5, checkpoint validation, TDD compliance checks
...
- **Traceability**: Load `/rules-traceability` for full traceability rules
