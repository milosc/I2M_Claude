...
hooks:
  ...
  Stop:
    - hooks:
        ...
        - type: command
          command: "$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" command /discovery-docs-all ended '{"stage": "discovery", "validated": true}'
---
...
## 🚨 MANDATORY Skills and Outputs (ALL 5 files required)

| # | File | Generated By | REQUIRED |
|---|------|--------------|----------|
| 1 | `05-documentation/INDEX.md` | Discovery_DocIndex | ✅ YES |
| 2 | `05-documentation/README.md` | Discovery_DocIndex | ✅ YES |
| 3 | `05-documentation/GETTING_STARTED.md` | Discovery_DocIndex | ✅ YES |
| 4 | `05-documentation/FILES_CREATED.md` | Discovery_DocIndex | ✅ YES |
| 5 | `05-documentation/DOCUMENTATION_SUMMARY.md` | Discovery_DocSummary | ✅ YES |

## Skills Used

- `.claude/skills/Discovery_DocIndex/Discovery_DocIndex.md` → Generates 4 files
- `.claude/skills/Discovery_DocSummary/Discovery_DocSummary.md` → Generates 1 file
...
|------|----------|-----------|
| `ClientAnalysis_<SystemName>/05-documentation/INDEX.md` | ✅ YES | Checkpoint 10 |
| `ClientAnalysis_<SystemName>/05-documentation/README.md` | ✅ YES | Checkpoint 10 |
| `ClientAnalysis_<SystemName>/05-documentation/DOCUMENTATION_SUMMARY.md` | ✅ YES | Checkpoint 10 |
| `ClientAnalysis_<SystemName>/05-documentation/GETTING_STARTED.md` | ✅ YES | Checkpoint 10 |
| `ClientAnalysis_<SystemName>/05-documentation/FILES_CREATED.md` | ✅ YES | Checkpoint 10 |
...
**Expected output:**
```
✅ Checkpoint 10 deliverables verified in ClientAnalysis_<SystemName>
```

**If validation FAILS:**
```
❌ QUALITY GATE FAILED: Missing mandatory deliverable for Checkpoint 10: 05-documentation/DOCUMENTATION_SUMMARY.md
```
