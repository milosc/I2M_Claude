---
name: rules-inline-docs
description: Load inline documentation standards (_readme.md convention)
---

# Inline Documentation Rules (On-Demand)

**Loaded when needed**: Running `/document` command, creating component/hook documentation
