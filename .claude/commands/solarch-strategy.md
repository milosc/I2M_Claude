...
hooks:
  ...
  Stop:
    - hooks:
        # VALIDATION: Check strategy document was created
        - type: command
          command: >-
        ...
        - type: command
          command: "$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" command /solarch-strategy ended '{"stage": "solarch", "validated": true}'
---
