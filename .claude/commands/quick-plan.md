...
# Bug fix
/quick-plan "Fix login timeout issue causing session drops"

# Refactoring task
/quick-plan "Refactor database queries for better performance"

# New component
/quick-plan "Add search functionality with autocomplete"
```

### What Gets Generated

The command creates a plan document in `specs/<descriptive-name>.md` containing:
...
### Difference from /plan_w_team

| Command | Model | Orchestration Prompt | Best For |
|---------|-------|---------------------|----------|
| `/quick-plan` | Sonnet | No | Fast planning, simpler tasks |
| `/plan_w_team` | Opus | Yes (optional) | Complex tasks, custom team orchestration |

Use `/quick-plan` for straightforward tasks. Use `/plan_w_team` when you need to customize team composition or execution strategy.
