...
```bash
# Create a named plan for version/run tracking
/plan_new_feature v1-auth

# Sprint-based naming
/plan_new_feature sprint-5-search

# Feature-based naming
/plan_new_feature user-notifications
```

### Output Location

Plans are saved to: `specs/plan_new_feature_<RUN_NAME>.md`

Examples:
- `/plan_new_feature v1-auth` → `specs/plan_new_feature_v1-auth.md`
- `/plan_new_feature sprint-5` → `specs/plan_new_feature_sprint-5.md`

### What Gets Generated

The command creates a plan document containing:
- **Task Description** and **Objective**
- **Relevant Files** to modify
- **Team Orchestration** with named team members
- **Step by Step Tasks** with dependencies and assignments
- **Acceptance Criteria** and **Validation Commands**

### When to Use This vs Other Planning Commands

| Command | Use Case |
|---------|----------|
| `/plan_new_feature <name>` | Named plans for tracking (sprints, versions) |
| `/quick-plan <prompt>` | Fast planning from a prompt |
| `/plan_w_team <prompt> <orchestration>` | Custom team orchestration |
...
- If no `RUN_NAME` is provided, stop and ask the user to provide it.
...
4. Define Team Members - Identify appropriate agents from `.claude/agents/*.md` for the task. Document in plan.
5. Define Step by Step Tasks - Write out tasks with IDs, dependencies, assignments. Document in plan.
6. Generate Filename - Use the format `plan_new_feature_<RUN_NAME>.md`
7. Save Plan - Write the plan to `PLAN_OUTPUT_DIRECTORY/plan_new_feature_<RUN_NAME>.md`
8. Save & Report - Follow the `Report` section and provide a summary of key components
