...
hooks:
  ...
  Stop:
    - hooks:
        # VALIDATION: Check GETTING_STARTED.md was created
        - type: command
          command: >-
            ...
            --requires "GETTING_STARTED.md"
        # VALIDATION: Check GETTING_STARTED has required sections
        - type: command
          command: >-
            ...
            --contains "## Welcome"
            --contains "## Reading Paths"
        # LOGGING: Record command completion
        - type: command
          command: "$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" command /discovery-getting-started ended '{"stage": "discovery", "validated": true}'
---
