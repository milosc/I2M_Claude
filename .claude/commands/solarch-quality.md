...
hooks:
  ...
  Stop:
    - hooks:
        # VALIDATION: Check quality review completed
        - type: command
          command: >-
        ...
        - type: command
          command: "$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" command /solarch-quality ended '{"stage": "solarch", "validated": true}'
---
