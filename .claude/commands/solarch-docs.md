...
hooks:
  ...
  Stop:
    - hooks:
        # VALIDATION: Check documentation package was created
        - type: command
          command: >-
        ...
        - type: command
          command: "$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" command /solarch-docs ended '{"stage": "solarch", "validated": true}'
---
