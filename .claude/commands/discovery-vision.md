...
hooks:
  ...
  Stop:
    - hooks:
        # VALIDATION: Check vision document was created
        - type: command
          command: >-
        ...
        - type: command
          command: "$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" command /discovery-vision ended '{"stage": "discovery", "validated": true}'
---
