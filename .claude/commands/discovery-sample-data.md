...
hooks:
  ...
  Stop:
    - hooks:
        # VALIDATION: Check sample-data.json was created
        - type: command
          command: >-
            ...
            --requires "sample-data.json"
        # LOGGING: Record command completion
        - type: command
          command: "$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" command /discovery-sample-data ended '{"stage": "discovery", "validated": true}'
---
