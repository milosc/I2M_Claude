---
name: transferring-code-precisely
allowed-tools: Bash
description: Use when you need to move or copy specific blocks of code, functions, or classes between files with precise line-based control.
hooks:
  Stop:
    - hooks:
        - type: command
...
```bash
bash .claude/hooks/log-lifecycle.sh skill transferring-code-precisely instruction_start '{"stage": "utility", "method": "instruction-based"}'
```
