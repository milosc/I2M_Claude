---
name: SECURITY_api-fuzzing-bug-bounty
...
hooks:
  PreToolUse:
    - matcher: "*"
      ...
      hooks:
        - type: command
          command: "$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" skill SECURITY_api-fuzzing-bug-bounty started '{"stage": "utility"}'
  Stop:
    - hooks:
        - type: command
          command: "$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" skill SECURITY_api-fuzzing-bug-bounty ended '{"stage": "utility"}'
metadata:
  version: "1.1"
---
