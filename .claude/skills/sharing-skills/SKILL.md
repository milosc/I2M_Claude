---
name: sharing-developed-skills
description: Use when you have developed a broadly useful skill and want to contribute it to an upstream repository via a pull request.
model: haiku
...
hooks:
  PreToolUse:
    - matcher: "*"
      ...
      hooks:
        - type: command
          command: "$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" skill sharing-developed-skills started '{"stage": "utility"}'
  Stop:
    - hooks:
        - type: command
          command: "$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" skill sharing-developed-skills ended '{"stage": "utility"}'
---
...
```bash
"$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" skill sharing-developed-skills instruction_start '{"stage": "utility", "method": "instruction-based"}'
```
