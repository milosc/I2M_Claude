---
name: planning-learning-quests
description: Use when you need to transform learning content into actionable implementation plans using the Ship-Learn-Next framework.
model: haiku
...
hooks:
  PreToolUse:
    - matcher: "*"
      ...
      hooks:
        - type: command
          command: "$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" skill planning-learning-quests started '{"stage": "utility"}'
  Stop:
    - hooks:
        - type: command
          command: "$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" skill planning-learning-quests ended '{"stage": "utility"}'
---
...
```bash
"$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" skill planning-learning-quests instruction_start '{"stage": "utility", "method": "instruction-based"}'
```
