---
name: converting-files-to-markdown
description: Use when you need to convert office documents, PDFs, images, or audio files into structured Markdown for easier analysis or token-efficient processing.
model: haiku
...
hooks:
  PreToolUse:
    - matcher: "*"
      ...
      hooks:
        - type: command
          command: "$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" skill converting-files-to-markdown started '{"stage": "utility"}'
  Stop:
    - hooks:
        - type: command
          command: "$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" skill converting-files-to-markdown ended '{"stage": "utility"}'
---
...
```bash
"$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" skill converting-files-to-markdown instruction_start '{"stage": "utility", "method": "instruction-based"}'
```
