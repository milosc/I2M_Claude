---
name: downloading-youtube-transcripts
description: Use when you need to download, fetch, or transcribe transcripts and captions from YouTube videos using a URL.
model: sonnet
...
hooks:
  PreToolUse:
    - matcher: "*"
      ...
      hooks:
        - type: command
          command: "$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" skill downloading-youtube-transcripts started '{"stage": "utility"}'
  Stop:
    - hooks:
        - type: command
          command: "$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" skill downloading-youtube-transcripts ended '{"stage": "utility"}'
---
...
```bash
"$CLAUDE_PROJECT_DIR/.claude/hooks/log-lifecycle.sh" skill downloading-youtube-transcripts instruction_start '{"stage": "utility", "method": "instruction-based"}'
```
