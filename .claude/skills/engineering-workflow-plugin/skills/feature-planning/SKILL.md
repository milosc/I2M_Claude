...
description: Use when you need to systematically analyze feature requests and create detailed, sequential implementation plans, including architectural decisions and individual task breakdowns.
hooks:
  Stop:
    - hooks:
        - type: command
...
```bash
bash .claude/hooks/log-lifecycle.sh skill planning-feature-implementation instruction_start '{"stage": "utility", "method": "instruction-based"}'
```
