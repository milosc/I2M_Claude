...
export interface Skill {
  ...
  tags?: string[];  // User-defined tags for filtering (JTBD-1.3, PF-002)
...
export interface UserPreferences {
  ...
  component_tags: Record<string, string[]>;  // User-added tags: { "skill_id": ["tag1", "tag2"] } (PF-002)
  tag_filter: string[];  // Active tag filters in search (PF-002)
  component_stages: Record<string, Stage[]>;  // User-modified stages: { "skill_id": ["Discovery", "Prototype"] } (PF-003)
}
...
export interface SkillQueryParams extends BaseQueryParams {
  ...
  has_example?: boolean;
  favorited?: boolean;
  tags?: string[];  // Filter by tags (PF-002)
}
